...
class LostFoundController extends ApiController
{
     ...
     */ 
    public function addLostFound(Request $request){ 
    ...
    public function list(Request $request){ 
        ...
        $query = App\LostFound::where('community_id', $request->community_id);
        $list = $query->get();
