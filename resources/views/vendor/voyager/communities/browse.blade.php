        ...
        <div class="row">
            <div class="col-md-11">
                <div class="admin-listing">
                    ...
                    @php
                    $address_types = $data->addressTypes()->where('community_address_types.status', 'active')->get();
                    @endphp
                    <div class="listing listing-{{ $data->status }} clearfix">
                          <div class="listing-left">
                              <img src="{{ Voyager::image($data->banner) }}">
                          </div>
                              ...
                              <div class="listing-detail">
                                  ...
                                  <ul class="listing-items">
                                    @foreach($address_types as $address_type)
                                        <li><span class="item-icon voyager-shop"></span><span class="item-label">{{ $address_type->title }} : </span><span class="item-number">{{ $address_type->addresses()->where('community_id', $data->id)->get()->count() }}</span></li>
                                    @endforeach
                                  </ul>
                              </div>
                          </div>
